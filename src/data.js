...
export const destData = {
  Bali: {
    ...
    bestMonths: "Go May to September for dry, sunny days. Skip December and January, the wettest months.",
  ...
  Vietnam: {
    ...
    bestMonths: "Go November to April for cool, dry weather. Skip June to August, the peak rainy months.",
  ...
  Thailand: {
    ...
    bestMonths: "Go November to February for cool, dry days. Skip September and October, the wettest months.",
  ...
  Maldives: {
    ...
    bestMonths: "Go November to April for dry skies and calm seas. Skip June to August, the wet monsoon.",
  ...
  "Sri Lanka": {
    ...
    bestMonths: "Go December to March for dry south and west coasts. Skip May to August, the southwest monsoon.",
  ...
  "New Zealand": {
    ...
    bestMonths: "Go December to February for warm summer days. Skip June to August, cold and wet in the south.",
...
export const allItineraries = [
  ...
  { id: 100, dest: "Bali", vibe: "Relaxed", name: "Ubud Retreat", nights: 5, price: "54,998", route: [{ city: "Ubud", n: 5 }], veg: true, img: baliImgs[2],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "High" },
  { id: 101, dest: "Bali", vibe: "Explorer", name: "Grand Bali Loop", nights: 12, price: "98,498", route: [{ city: "Ubud", n: 2 }, { city: "Kintamani", n: 2 }, { city: "Amed", n: 2 }, { city: "Nusa Penida", n: 3 }, { city: "Seminyak", n: 3 }], veg: false, img: baliImgs[4],
    days: [{ city: "Ubud", n: 2, sub: "Temples · Rice fields" }, { city: "Kintamani", n: 2, sub: "Volcano sunrise · Coffee" }, { city: "Amed", n: 2, sub: "Dive · Snorkel · Sunrise" }, { city: "Nusa Penida", n: 3, sub: "Kelingking · Manta Bay" }, { city: "Seminyak", n: 3, sub: "Beach clubs · Dining" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 102, dest: "Bali", vibe: "Explorer", name: "Island Hopper", nights: 13, price: "1,12,498", route: [{ city: "Ubud", n: 2 }, { city: "Sidemen", n: 2 }, { city: "Amed", n: 2 }, { city: "Nusa Penida", n: 2 }, { city: "Lembongan", n: 2 }, { city: "Seminyak", n: 3 }], veg: false, img: baliImgs[1],
    days: [{ city: "Ubud", n: 2, sub: "Culture · Temples" }, { city: "Sidemen", n: 2, sub: "Valley · Crafts" }, { city: "Amed", n: 2, sub: "Diving · Sunrise" }, { city: "Nusa Penida", n: 2, sub: "Beaches · Cliffs" }, { city: "Lembongan", n: 2, sub: "Snorkel · Mangroves" }, { city: "Seminyak", n: 3, sub: "Beach · Shopping" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 103, dest: "Bali", vibe: "Explorer", name: "All of Bali", nights: 14, price: "1,28,498", route: [{ city: "Ubud", n: 2 }, { city: "Kintamani", n: 1 }, { city: "Sidemen", n: 2 }, { city: "Amed", n: 2 }, { city: "Munduk", n: 2 }, { city: "Pemuteran", n: 2 }, { city: "Seminyak", n: 3 }], veg: true, img: baliImgs[3],
    days: [{ city: "Ubud", n: 2, sub: "Culture · Spa" }, { city: "Kintamani", n: 1, sub: "Mt Batur sunrise" }, { city: "Sidemen", n: 2, sub: "Rice valley walks" }, { city: "Amed", n: 2, sub: "Shipwreck dive" }, { city: "Munduk", n: 2, sub: "Waterfalls · Lakes" }, { city: "Pemuteran", n: 2, sub: "Coral garden snorkel" }, { city: "Seminyak", n: 3, sub: "Sunset bars · Beach" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "High" },
  { id: 104, dest: "Bali", vibe: "Explorer", name: "Coast to Coast", nights: 15, price: "1,42,998", route: [{ city: "Canggu", n: 2 }, { city: "Ubud", n: 2 }, { city: "Kintamani", n: 1 }, { city: "Sidemen", n: 2 }, { city: "Amed", n: 2 }, { city: "Lovina", n: 2 }, { city: "Munduk", n: 2 }, { city: "Seminyak", n: 2 }], veg: false, img: baliImgs[5],
    days: [{ city: "Canggu", n: 2, sub: "Surf · Beach clubs" }, { city: "Ubud", n: 2, sub: "Temples · Yoga" }, { city: "Kintamani", n: 1, sub: "Volcano sunrise" }, { city: "Sidemen", n: 2, sub: "Valley walks" }, { city: "Amed", n: 2, sub: "Diving · Snorkel" }, { city: "Lovina", n: 2, sub: "Dolphins · Black sand" }, { city: "Munduk", n: 2, sub: "Waterfalls" }, { city: "Seminyak", n: 2, sub: "Sunset · Dining" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 105, dest: "Bali", vibe: "Explorer", name: "Bali Marathon", nights: 17, price: "1,58,498", route: [{ city: "Canggu", n: 2 }, { city: "Ubud", n: 2 }, { city: "Kintamani", n: 1 }, { city: "Sidemen", n: 2 }, { city: "Amed", n: 2 }, { city: "Lovina", n: 1 }, { city: "Munduk", n: 2 }, { city: "Pemuteran", n: 2 }, { city: "Seminyak", n: 3 }], veg: true, img: baliImgs[0],
    days: [{ city: "Canggu", n: 2, sub: "Surf · Beach" }, { city: "Ubud", n: 2, sub: "Culture" }, { city: "Kintamani", n: 1, sub: "Volcano" }, { city: "Sidemen", n: 2, sub: "Valley" }, { city: "Amed", n: 2, sub: "Dive" }, { city: "Lovina", n: 1, sub: "Dolphins" }, { city: "Munduk", n: 2, sub: "Waterfalls" }, { city: "Pemuteran", n: 2, sub: "Snorkel" }, { city: "Seminyak", n: 3, sub: "Beach clubs" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "High" },
  { id: 106, dest: "Bali", vibe: "Explorer", name: "Bali Grand Tour", nights: 18, price: "1,72,998", route: [{ city: "Canggu", n: 2 }, { city: "Ubud", n: 2 }, { city: "Kintamani", n: 1 }, { city: "Sidemen", n: 2 }, { city: "Amed", n: 2 }, { city: "Lovina", n: 1 }, { city: "Munduk", n: 2 }, { city: "Pemuteran", n: 2 }, { city: "Nusa Penida", n: 2 }, { city: "Seminyak", n: 2 }], veg: false, img: baliImgs[4],
    days: [{ city: "Canggu", n: 2, sub: "Surf" }, { city: "Ubud", n: 2, sub: "Culture" }, { city: "Kintamani", n: 1, sub: "Volcano" }, { city: "Sidemen", n: 2, sub: "Valley" }, { city: "Amed", n: 2, sub: "Dive" }, { city: "Lovina", n: 1, sub: "Dolphins" }, { city: "Munduk", n: 2, sub: "Waterfalls" }, { city: "Pemuteran", n: 2, sub: "Snorkel" }, { city: "Nusa Penida", n: 2, sub: "Beaches" }, { city: "Seminyak", n: 2, sub: "Sunset" }],
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  // Vietnam (3)

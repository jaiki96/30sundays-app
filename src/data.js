...
export const allItineraries = [
  // Bali (9)
  { id: 1, dest: "Bali", vibe: "Relaxed", nights: 7, price: "62,498", route: [{ city: "Ubud", n: 2 }, { city: "Seminyak", n: 2 }, { city: "Sanur", n: 3 }], veg: true, img: baliImgs[0],
  ...
  { id: 2, dest: "Bali", vibe: "Relaxed", nights: 5, price: "78,998", route: [{ city: "Seminyak", n: 2 }, { city: "Nusa Dua", n: 3 }], veg: false, img: baliImgs[1],
  ...
  { id: 3, dest: "Bali", vibe: "Relaxed", nights: 7, price: "72,498", route: [{ city: "Ubud", n: 3 }, { city: "Kintamani", n: 2 }, { city: "Sanur", n: 2 }], veg: true, img: baliImgs[2],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "High" },
  { id: 4, dest: "Bali", vibe: "Explorer", nights: 7, price: "58,498", route: [{ city: "Ubud", n: 2 }, { city: "Kintamani", n: 2 }, { city: "Canggu", n: 3 }], veg: false, img: baliImgs[3],
  ...
  { id: 5, dest: "Bali", vibe: "Explorer", nights: 10, price: "82,998", route: [{ city: "Ubud", n: 3 }, { city: "Amed", n: 3 }, { city: "Nusa Penida", n: 2 }, { city: "Seminyak", n: 2 }], veg: true, img: baliImgs[4],
  ...
  { id: 6, dest: "Bali", vibe: "Explorer", nights: 5, price: "48,998", route: [{ city: "Seminyak", n: 2 }, { city: "Uluwatu", n: 1 }, { city: "Nusa Penida", n: 2 }], veg: false, img: baliImgs[5],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 7, dest: "Bali", vibe: "Offbeat", nights: 7, price: "55,998", route: [{ city: "Sidemen", n: 3 }, { city: "Munduk", n: 2 }, { city: "Amed", n: 2 }], veg: false, img: baliImgs[3],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "Medium" },
  { id: 8, dest: "Bali", vibe: "Offbeat", nights: 5, price: "48,998", route: [{ city: "Sidemen", n: 2 }, { city: "Munduk", n: 3 }], veg: true, img: baliImgs[4],
    days: [{ city: "Sidemen", n: 2, sub: "Rice fields · Village walks" }, { city: "Munduk", n: 3, sub: "Waterfalls · Star gazing · Treks" }],
    pace: "Unhurried", crowds: "Low", vegFood: "High" },
  { id: 9, dest: "Bali", vibe: "Offbeat", nights: 7, price: "62,498", route: [{ city: "Munduk", n: 2 }, { city: "Pemuteran", n: 3 }, { city: "Lovina", n: 2 }], veg: false, img: baliImgs[5],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "Medium" },
  // Vietnam (3)
  { id: 10, dest: "Vietnam", vibe: "Explorer", nights: 7, price: "65,098", route: [{ city: "Hanoi", n: 2 }, { city: "Ha Long", n: 2 }, { city: "HCMC", n: 3 }], veg: false, img: vietnamImgs[5],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 11, dest: "Vietnam", vibe: "Relaxed", nights: 7, price: "72,498", route: [{ city: "Da Nang", n: 3 }, { city: "Hoi An", n: 2 }, { city: "Phu Quoc", n: 2 }], veg: true, img: vietnamImgs[0],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "High" },
  { id: 12, dest: "Vietnam", vibe: "Offbeat", nights: 7, price: "68,498", route: [{ city: "Ninh Binh", n: 2 }, { city: "Phong Nha", n: 3 }, { city: "Hoi An", n: 2 }], veg: true, img: vietnamImgs[6],
  ...
  // Thailand (3)
  { id: 13, dest: "Thailand", vibe: "Explorer", nights: 7, price: "62,498", route: [{ city: "Bangkok", n: 3 }, { city: "Chiang Mai", n: 2 }, { city: "Krabi", n: 2 }], veg: false, img: thailandImgs[0],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 14, dest: "Thailand", vibe: "Relaxed", nights: 7, price: "68,998", route: [{ city: "Bangkok", n: 2 }, { city: "Phuket", n: 3 }, { city: "Koh Samui", n: 2 }], veg: false, img: thailandImgs[2],
  ...
  { id: 15, dest: "Thailand", vibe: "Offbeat", nights: 7, price: "55,998", route: [{ city: "Chiang Mai", n: 3 }, { city: "Chiang Rai", n: 2 }, { city: "Pai", n: 2 }], veg: true, img: thailandImgs[3],
  ...
  { id: 18, dest: "Maldives", vibe: "Explorer", nights: 7, price: "95,498", route: [{ city: "Malé", n: 2 }, { city: "S.Ari", n: 3 }, { city: "Fuvahmulah", n: 2 }], veg: false, resort: "Centara Grand", img: maldivesImgs[6],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  // Sri Lanka (3)
  { id: 19, dest: "Sri Lanka", vibe: "Relaxed", nights: 7, price: "54,998", route: [{ city: "Kandy", n: 2 }, { city: "Ella", n: 2 }, { city: "Mirissa", n: 3 }], veg: false, img: slImgs[17],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "Medium" },
  { id: 20, dest: "Sri Lanka", vibe: "Explorer", nights: 7, price: "58,498", route: [{ city: "Colombo", n: 2 }, { city: "Sigiriya", n: 2 }, { city: "Galle", n: 3 }], veg: false, img: slImgs[5],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 21, dest: "Sri Lanka", vibe: "Offbeat", nights: 7, price: "54,998", route: [{ city: "Sigiriya", n: 2 }, { city: "Trincomalee", n: 3 }, { city: "Yala", n: 2 }], veg: false, img: slImgs[14],
  ...
  // New Zealand (3)
  { id: 22, dest: "New Zealand", vibe: "Explorer", nights: 10, price: "1,85,098", route: [{ city: "Auckland", n: 2 }, { city: "Queenstown", n: 4 }, { city: "Rotorua", n: 4 }], veg: false, img: nzImgs[0],
    ...
    pace: "Balanced", crowds: "Mixed", vegFood: "Medium" },
  { id: 23, dest: "New Zealand", vibe: "Relaxed", nights: 7, price: "1,65,098", route: [{ city: "Auckland", n: 2 }, { city: "Rotorua", n: 3 }, { city: "Waiheke", n: 2 }], veg: false, img: nzImgs[8],
    ...
    pace: "Unhurried", crowds: "Low", vegFood: "Medium" },
  { id: 24, dest: "New Zealand", vibe: "Offbeat", nights: 10, price: "1,95,098", route: [{ city: "Christchurch", n: 3 }, { city: "Milford", n: 4 }, { city: "Wanaka", n: 3 }], veg: false, img: nzImgs[4],
